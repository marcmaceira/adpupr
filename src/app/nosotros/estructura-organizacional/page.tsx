...
const BOARD_MEMBERS: readonly BoardMember[] = [
  {
    ...
    image: `${BLOB_STORAGE_URL}/jonnathan-garcia-c62e3a40-d4b6-47cd-982c-abc816eb1059.png`,
  },
  {
    role: "Vicepresidente",
    ...
    image: `${BLOB_STORAGE_URL}/luis-matos-2b67915d-b6cc-4b95-ad2e-b5c465a42ea9.png`,
  },
  {
    ...
    image: `${BLOB_STORAGE_URL}/mariluz-serrano-82cca165-f382-4b59-9021-6722ec453d73.png`,
  },
  {
    ...
    image: `${BLOB_STORAGE_URL}/juan-david-d39b7bbc-dda3-4527-8f5d-d6400cd0e663.png`,
  },
  {
    ...
    image: `${BLOB_STORAGE_URL}/victoria-ramirez-cee9d93e-160d-46ad-b8e0-baf225f2b9e8.png`,
  },
  {
    ...
    image: `${BLOB_STORAGE_URL}/janiel-de-jesus-7e19a5ae-dd35-43fa-b117-21e6e25e3662.png`,
  },
  {
    role: "Vocal de la Junta de Directores",
    ...
    image: `${BLOB_STORAGE_URL}/ana-rodriguez-edd82bd9-04dc-4206-9af9-04d2a53708d3.png`,
  },
] as const;
        ...
        <section className="relative overflow-hidden bg-primary px-6 py-20 text-white md:py-28">
          ...
          <div className="relative mx-auto max-w-[1200px]">
            ...
            <p className="mt-7 max-w-[620px] font-body text-lg leading-[1.7] text-text-on-dark-muted">
              Conozca a quienes integran la Junta Directiva y c&oacute;mo se organiza el trabajo
              institucional de la ADPUPR.
            </p>
            <nav className="mt-9 flex flex-wrap gap-3" aria-label={"Contenido de la p\u00E1gina"}>
              <a
          ...
          <div className="mx-auto max-w-[1200px]">
            <div className="mb-12 grid gap-6 border-b border-border-strong pb-10 md:grid-cols-[1fr_0.8fr] md:items-end">
              ...
              <p className="font-body text-base leading-[1.7] text-text-muted md:justify-self-end md:text-right">
                Profesionales comprometidos con fortalecer la administraci&oacute;n p&uacute;blica
                de Puerto Rico.
              </p>
            </div>
