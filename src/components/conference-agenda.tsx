...
const MORNING = [
  ...
  { start: "10:35 a.m.", end: "10:40 a.m.", title: "Mensaje de patrocinadores", quiet: true },
  {
    ...
    description: "Di\u00E1logo entre el Estado, la academia, el sector privado y el tercer sector.",
  },
...
const AFTERNOON = [
  ...
  },
  {
    ...
    title: "Laboratorio de reacci\u00F3n del p\u00FAblico, s\u00EDntesis y cierre acad\u00E9mico",
    description:
  ...
  },
  {
    ...
    description: "Validaci\u00F3n de membres\u00EDa activa y registro de participantes.",
    quiet: true,
  },
  {
    start: "4:15 p.m.",
...
function ScheduleEntry({ entry }: { readonly entry: AgendaEntry }) {
  const content = (
    <>
      ...
      <p
        className={`min-w-0 font-heading text-base ${entry.quiet ? "font-medium text-text-muted" : "font-semibold text-primary sm:text-lg"}`}
      >
        {entry.title}
      </p>
    </>
...
export default function ConferenceAgenda() {
  ...
  return (
    <section
      id="agenda"
      aria-labelledby="inline-agenda-heading"
      className="mt-10 border-t border-primary/15 pt-8 sm:mt-12"
    >
      <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:justify-between">
        <h2
          id="inline-agenda-heading"
        ...
        <button
          ...
          aria-controls="inline-agenda-content"
      ...
      <div id="inline-agenda-content" hidden={!expanded} className="pt-8">
        <div className="grid gap-8 border-t border-primary/20 py-8 lg:grid-cols-[1fr_3fr] lg:gap-20">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-text-muted sm:text-sm">
              Apertura, investigaci&oacute;n y di&aacute;logo multisectorial.
            </p>
          </div>
        ...
        <div className="grid gap-8 border-t border-primary/20 py-8 lg:grid-cols-[1fr_3fr] lg:gap-20">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-text-muted sm:text-sm">
              Experiencias, propuestas y encuentro de la membres&iacute;a.
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 border-t border-primary/20 pt-6">
          ...
          <div className="flex w-full flex-col items-start gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-6">
            ...
            <a href="#inscripcion" className={BUTTON}>
              Ver tarifas e inscripci&oacute;n{" "}
